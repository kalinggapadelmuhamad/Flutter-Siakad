...
mixin _$ScheduleState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Schedule> data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Schedule> data)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Schedule> data) : _data = data;
  ...
  @override
  String toString() {
    return 'ScheduleState.loaded(data: $data)';
  }
...
abstract class _Loaded implements ScheduleState {
  const factory _Loaded(final List<Schedule> data) = _$LoadedImpl;
