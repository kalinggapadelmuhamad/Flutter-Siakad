...
class __$$LoginImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? authRequestModel = freezed,
  }) {
    return _then(_$LoginImpl(
      freezed == authRequestModel
...
class _$LoginImpl implements _Login {
  const _$LoginImpl(this.authRequestModel);
  ...
  @override
  String toString() {
    return 'LoginEvent.login(authRequestModel: $authRequestModel)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.authRequestModel, authRequestModel));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(authRequestModel));
...
abstract class _Login implements LoginEvent {
  const factory _Login(final AuthRequestModel authRequestModel) = _$LoginImpl;
