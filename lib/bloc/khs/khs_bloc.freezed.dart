...
mixin _$KhsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Khs> data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Khs> data)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Khs> data) : _data = data;

  final List<Khs> _data;
  @override
  List<Khs> get data {
  ...
  @override
  String toString() {
    return 'KhsState.loaded(data: $data)';
  }
...
abstract class _Loaded implements KhsState {
  const factory _Loaded(final List<Khs> data) = _$LoadedImpl;
